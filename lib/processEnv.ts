...
export const ghostAPIUrl = process.env.CMS_GHOST_API_URL || 'https://krvbsblog.herokuapp.com'
export const ghostAPIKey = process.env.CMS_GHOST_API_KEY || 'f375fa9d33855a4ac661fc566b'
